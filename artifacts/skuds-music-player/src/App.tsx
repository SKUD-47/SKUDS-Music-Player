...
{songs.map((song, index) => <div key={song.id} className={`list-row relative flex items-center gap-3 border-b border-border/70 px-3 py-2.5 last:border-0 sm:px-4 ${menuId === song.id ? 'z-30' : 'z-0'}`}>
