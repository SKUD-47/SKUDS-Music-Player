...
function TrackMenu({ song, onClose, onAddPlaylist, onInfo, onEdit, onRemove, removeLabel = 'Remove track' }: { song: StoredSong; onClose: () => void; onAddPlaylist: () => void; onInfo: () => void; onEdit: () => void; onRemove?: () => void; removeLabel?: string }) {
  const library = useLibraryContext();
